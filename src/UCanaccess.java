...
public class UCanaccess extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(UCanaccess.class.getName());
    ...
    private void initComponents() {
        ...
        btnsearch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/search-interface-symbol.png"))); // NOI18N
        ...
        btnupdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/changes.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new UCanaccess().setVisible(true));
    }
